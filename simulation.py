...
# Exit list file
exitListFile = open('./output/output_og.csv', 'w')
...
class Vehicle(pygame.sprite.Sprite):
    ...
    def cross(self):
        ...
        with open(f'output/output_og.csv', 'a'):
            print(
                f'{self.direction};{self.lane};{self.vehicleClass};{self.index};{wait_time};{time.strftime('%H:%M:%S', time.localtime())}')
...
class Main:
    ...
    pygame.display.set_caption("Original simulation, fixed times")
